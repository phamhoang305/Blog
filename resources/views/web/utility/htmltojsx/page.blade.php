...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('utility/htmltojsx/react.css') }}" />
  <link rel="stylesheet" href="{{ asset('utility/htmltojsx/syntax.css') }}" />
</head>
<body>
  <div class="jsxCompiler">
    ...
    <script src="{{ asset('utility/htmltojsx/live_editor.js') }}"></script>
    <script src="{{ asset('utility/htmltojsx/htmltojsx.min.js') }}"></script>
    <script src="{{ asset('utility/htmltojsx/htmltojsx-component.js') }}"></script>
  </div>
</body>
</html>
