...
return [
     ...
     */
    'model' => \App\Http\Controllers\Comments\Comment::class,
     ...
     */
    'permissions' => [
        'create-comment' => 'App\Http\Controllers\Comments\CommentPolicy@create',
        'delete-comment' => 'App\Http\Controllers\Comments\CommentPolicy@delete',
        'edit-comment' => 'App\Http\Controllers\Comments\CommentPolicy@update',
        'reply-to-comment' => 'App\Http\Controllers\Comments\CommentPolicy@reply',
    ],
