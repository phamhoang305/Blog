function GradientCanvas(t, e, n) {
	this._colorStops = [], this._alphaStops = [], this.angle = n || 0 == n ? n : 90, t = t || [];
	for (var i = 0; t.length > i; i++) this.addColorStop(t[i].offset, t[i].color);
	e = e || [];
	for (var i = 0; e.length > i; i++) this.addAlphaStop(e[i].offset, e[i].alpha)
}
...
function pickHex(t, e, n) {
	...
	"object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t.one = t.one || {}, t.one.color = e())
}(this, function () {
	"use strict";

	function t(e) {
		if (Array.isArray(e)) {
			if ("string" == typeof e[0] && "function" == typeof t[e[0]]) return new t[e[0]](e.slice(1, e.length));
			if (4 === e.length) return new t.RGB(e[0] / 255, e[1] / 255, e[2] / 255, e[3] / 255)
		} else if ("string" == typeof e) {
			var i = e.toLowerCase();
			t.namedColors[i] && (e = "#" + t.namedColors[i]), "transparent" === i && (e = "rgba(0,0,0,0)");
			var s = e.match(r);
			if (s) {
				var a = s[1].toUpperCase(),
					...
					p = s[5] || c ? 100 : 255,
					d = s[7] || c ? 100 : 255;
				if (n(t[a])) throw new Error("color." + a + " is not installed.");
			...
			if (f) return new t.RGB(parseInt(f[1], 16) / 255, parseInt(f[2], 16) / 255, parseInt(f[3], 16) / 255);
			if (t.CMYK) {
				var h = e.match(new RegExp("^cmyk\\(" + o.source + "," + o.source + "," + o.source + "," + o.source + "\\)$", "i"));
				if (h) return new t.CMYK(parseFloat(h[1]) / 100, parseFloat(h[2]) / 100, parseFloat(h[3]) / 100, parseFloat(h[4]) / 100)
			}
	...
	t.namedColors = {}, t.installColorSpace = function (i, o, r) {
		function s(e, n) {
			var i = {};
			...
			for (var o in i) i.hasOwnProperty(o) && void 0 === t[e].prototype[o] && (t[e].prototype[o] = i[o])
		}
		t[i] = function (t) {
			var e = Array.isArray(t) ? t : arguments;
			o.forEach(function (t, n) {
				var r = e[n];
				if ("alpha" === t) this._alpha = isNaN(r) || r > 1 ? 1 : r < 0 ? 0 : r;
				else {
					if (isNaN(r)) throw new Error("[" + i + "]: Invalid color: (" + o.join(",") + ")");
		...
		}), a.isColor = !0, a.equals = function (t, e) {
			n(e) && (e = 1e-10), t = t[i.toLowerCase()]();
			for (var r = 0; r < o.length; r += 1)
				if (Math.abs(this["_" + o[r]] - t["_" + o[r]]) > e) return !1;
			return !0
		}, a.toJSON = function () {
	...
	}, t.pluginList = [], t.use = function (e) {
		return -1 === t.pluginList.indexOf(e) && (this.pluginList.push(e), e(t)), t
	...
	var s = t,
		a = function (t) {
			t.installColorSpace("HSV", ["hue", "saturation", "value", "alpha"], {
				rgb: function () {
					var e, n, i, o = this._hue,
						r = this._saturation,
						s = this._value,
						a = Math.min(5, Math.floor(6 * o)),
						u = 6 * o - a,
						c = s * (1 - r),
						l = s * (1 - u * r),
						p = s * (1 - (1 - u) * r);
				...
				hsl: function () {
					var e, n = (2 - this._saturation) * this._value,
						...
						o = n <= 1 ? n : 2 - n;
					return e = o < 1e-9 ? 0 : i / o, new t.HSL(this._hue, e, n / 2, this._alpha)
				},
				fromRgb: function () {
					var e, n = this._red,
						i = this._green,
		...
		u = function (t) {
			t.use(a), t.installColorSpace("HSL", ["hue", "saturation", "lightness", "alpha"], {
				hsv: function () {
					var e, n = 2 * this._lightness,
						i = this._saturation * (n <= 1 ? n : 2 - n);
					return e = n + i < 1e-9 ? 0 : 2 * i / (n + i), new t.HSV(this._hue, e, (n + i) / 2, this._alpha)
				},
				rgb: function () {
					return this.hsv().rgb()
				},
...
function (t, e) {
	...
	function e(t, e, n) {
		...
		return i.className = e, n.appendChild(i), i
	}
	...
	function o(t, n, i) {
		var o = e("label", "", n);
		return o.innerHTML = t, i && o.setAttribute("for", i), o
	}

	function r(t, n, i, o) {
		var r = e("input", "", n);
		return r.type = t, i && (r.maxLength = i), o && r.setAttribute("id", o), i && (r.maxLength = i), r
	}
	...
	function p(t, e, n) {
		...
		var l = s.split(""),
			p = "A" == s[s.length - 1];
		if (s = p ? s.slice(0, -1) : s, ["RGB", "RGBA", "HSL", "HSV", "CMYK"].indexOf(s) < 0) return console.warn("Invalid field names", s);
		var d = k.div("colorFields", t),
			f = l.map(function (t) {
				t = t.toLowerCase();
				var e = k.labelInput("color " + t, t, d, c);
				return e.input.onblur = i, e.input.onkeydown = o, e.input.onkeyup = r, {
					name: t,
					e: e
				}
			});
	...
	function d(t, e) {
		...
		function i(t) {
			...
			k.X(t.pointer, n), e.setAlpha(1 - n)
		}
		var o = O.slider({
			parent: t,
			"class": "oned alpha",
	...
	function f(t, e, n) {
		...
		return i.input.value = "#", i.input.onkeyup = function (t) {
			var n = t.keyCode || t.which,
				i = t.target.value;
			i = "#" == i[0] ? i : "#" + i, i = g(i, 7, "0"), 13 == n && e.set(i)
		}, i.input.onblur = function (t) {
			e.set(t.target.value), e.done()
		}, {
			change: function (t) {
				i.input.value = "#" == i.input.value[0] ? "#" : "", i.input.value += t.hex().slice(1)
			}
		}
	}
	...
	function h(t, e, n) {
		...
		i.href = "#", i.innerHTML = n.label || "Close", i.onclick = function (t) {
			t.preventDefault(), e.hide()
		}
	}

	function g(t, e, n) {
		for (var i = t, o = t.length; o < e; o++) i += n;
		return i
	}
	...
	function m(t) {
		...
		function n(t) {
			f = u.z(f, k.clamp(t.x, 0, 1), c, d), i()
		}

		function i(t) {
			t = C(t) ? t : [];
			for (var e, n = s.change, i = 0, o = n.length; i < o; i++) e = n[i], -1 == t.indexOf(e.name) && e.fn(f)
		}

		function o() {
			if (!r.equals(f)) {
				for (var t = 0, e = s.done.length; t < e; t++) s.done[t].fn(f);
				r = f
			}
		}
		...
		var p = {
			...
			set: function (t) {
				var e = this.get();
				return f = u.init(y(t), c, d), e.equals(f) || this.update(), this
			},
			getAlpha: function () {
				return f.alpha()
			},
			...
			on: function (t, e, n) {
				return "change" == t || "done" == t ? s[t].push({
					name: n,
					fn: e
				}) : console.warn('Passed invalid evt name "' + t + '" to colorjoe.on'), this
			},
	...
	function y(e) {
		...
		var n = t(e);
		return n || (_(e) && console.warn("Passed invalid color to colorjoe, using black instead"), t("#000"))
	}

	function x(t, n) {
		var i, o = e,
			r = {};
		i = (0, P._extras.alpha)(t, w(n, o + 0), r);
		for (var s in i) n.on(s, i[s], o)
	}
	...
	function b(t, e, n) {
		if (n) {
			...
			n.forEach(function (t, n) {
				if ("alpha" !== t) {
					C(t) ? (o = t[0], r = t.length > 1 ? t[1] : {}) : (o = t, r = {});
					var a = o in P._extras ? P._extras[o] : null;
					if (a) {
						i = a(s, w(e, o + n), r);
						for (var u in i) e.on(u, i[u], o)
					}
				}
			})
		}
...
https://bebraw.github.com/dragjs - 2016-08-12 */
	var O = function () {
			function t(t, e) {
				...
				s(t, e, "touchstart", "touchmove", "touchend"), s(t, e, "mousedown", "mousemove", "mouseup")
			}

			function e(e) {
				var n = o(e["class"] || "", e.parent),
					r = o("pointer", n);
				return o("shape shape1", r), o("shape shape2", r), o("bg bg1", n), o("bg bg2", n), t(n, i(e.cbs, r)), {
					background: n,
					pointer: r
				}
			}
			...
			function n(e) {
				...
				o("shape", r);
				var s = o("bg", n);
				return e && "oned alpha" === e["class"] && o("bg-color js-alpha-color", s), t(n, i(e.cbs, r)), {
					background: n,
					pointer: r
				}
			}
			...
			function r(t, e, n) {
				var i = document.createElement(t);
				return e && (i.className = e), n.appendChild(i), i
			}
			...
			function s(t, e, n, i, o) {
				...
				a(t, n, function (e) {
					function n() {
						r = !1, u(document, i, c), u(document, o, n), d(p, t, e)
					}
					r = !0;
					var c = f(d, l, t);
					a(document, i, c), a(document, o, n), d(s, t, e)
				})
			}
			...
			function c(t) {
				...
				return {
					...
					change: function (t) {
						l(t.elem, "left", e.x + t.cursor.x - n.x + "px"), l(t.elem, "top", e.y + t.cursor.y - n.y + "px")
					},
					end: p
				}
			}
	...
	P.rgb = P({
		init: function (e, n, i) {
			...
			return this.xy(o, {
				x: o.saturation(),
				y: 1 - o.value()
			}, n, i), this.z(o, o.hue(), n, i), o
		},
		xy: function (t, e, n) {
			return k.X(n.pointer, e.x), k.Y(n.pointer, e.y), t.saturation(e.x).value(1 - e.y)
		},
		z: function (t, e, n, i) {
			return k.X(i.pointer, e), v(n.background, e), t.hue(e)
		}
	}), P.hsl = P({
		init: function (e, n, i) {
			var o = t(e).hsl();
			return this.xy(o, {
				x: o.hue(),
				y: 1 - o.saturation()
			}, n, i), this.z(o, 1 - o.lightness(), n, i), o
		},
		xy: function (t, e, n, i) {
			return k.X(n.pointer, e.x), k.Y(n.pointer, e.y), v(i.background, e.x), t.hue(e.x).saturation(1 - e.y)
		},
		z: function (t, e, n, i) {
			return k.Y(i.pointer, e), t.lightness(1 - e)
		}
	}), P._extras = {}, P.registerExtra = function (t, e) {
		t in P._extras && console.warn('Extra "' + t + '"has been registered already!'), P._extras[t] = e
	};
	for (var D in A) P.registerExtra(D, A[D]);
	return P
}),
/**
 * interact.js v1.3.0
	...
	return function t(e, n, i) {
					...
					r = function () {
						...
						return t.prototype.fire = function (t) {
							var e = void 0,
								n = "on" + t.type,
								o = this.global;
							(e = this[t.type]) && i(t, e), this[n] && this[n](t), !t.propagationStopped && o && (e = o[t.type]) && i(t, e)
						}, t.prototype.on = function (t, e) {
							this[t] ? this[t].push(e) : this[t] = [e]
						}, t.prototype.off = function (t, e) {
							var n = this[t],
								i = n ? n.indexOf(e) : -1; - 1 !== i && n.splice(i, 1), (n && 0 === n.length || !e) && (this[t] = undefined)
						}, t
					}();
				e.exports = r
			}, {
			...
			function (t, e) {
				...
				var i = t("./utils/extend"),
					...
					a = function () {
						function t(e, a, u, c, l, p) {
							...
							var b = i({}, y.page),
								w = i({}, y.client);
							b.x -= g.x, b.y -= g.y, w.x -= g.x, w.y -= g.y, this.ctrlKey = a.ctrlKey, this.altKey = a.altKey, this.shiftKey = a.shiftKey, this.metaKey = a.metaKey, this.button = a.button, this.buttons = a.buttons, this.target = l, this.currentTarget = l, this.relatedTarget = p || null, this.preEnd = d, this.type = u + (c || ""), this.interaction = e, this.interactable = f, this.t0 = v ? e.downTimes[e.downTimes.length - 1] : x.t0;
							var S = {
								interaction: e,
								event: a,
								action: u,
							...
							s.fire("set-xy", S), m ? (this.pageX = x.pageX, this.pageY = x.pageY, this.clientX = x.clientX, this.clientY = x.clientY) : (this.pageX = b.x, this.pageY = b.y, this.clientX = w.x, this.clientY = w.y), this.x0 = e.startCoords.page.x - g.x, this.y0 = e.startCoords.page.y - g.y, this.clientX0 = e.startCoords.client.x - g.x, this.clientY0 = e.startCoords.client.y - g.y, s.fire("set-delta", S), this.timeStamp = y.timeStamp, this.dt = e.pointerDelta.timeStamp, this.duration = this.timeStamp - this.t0, this.speed = e.pointerDelta[h].speed, this.velocityX = e.pointerDelta[h].vx, this.velocityY = e.pointerDelta[h].vy, this.swipe = m || "inertiastart" === c ? this.getSwipe() : null, s.fire("new", S)
						}
				...
				s.on("set-delta", function (t) {
					var e = t.iEvent,
						...
						o = t.deltaSource,
						r = i ? e : n.prevEvent;
					"client" === o ? (e.dx = e.clientX - r.clientX, e.dy = e.clientY - r.clientY) : (e.dx = e.pageX - r.pageX, e.dy = e.pageY - r.pageY)
				}), a.signals = s, e.exports = a
			}, {
				"./defaultOptions": 18,
				"./utils/Signals": 34,
				"./utils/extend": 40,
		...
		4: [
			function (t, e) {
				...
				var S = function () {
					function t(e, i) {
						n(this, t), i = i || {}, this.target = e, this.events = new u, this._context = i.context || a.document, this._win = m(h(e) ? this._context : e), this._doc = this._win.document, l.fire("new", {
							target: e,
							options: i,
							interactable: this,
							win: this._win
						}), a.addDocument(this._doc, this._win), a.interactables.push(this), this.set(i)
					}
					return t.prototype.setOnEvents = function (t, e) {
						var n = "on" + t;
						return i["function"](e.onstart) && (this.events[n + "start"] = e.onstart), i["function"](e.onmove) && (this.events[n + "move"] = e.onmove), i["function"](e.onend) && (this.events[n + "end"] = e.onend), i["function"](e.oninertiastart) && (this.events[n + "inertiastart"] = e.oninertiastart), this
					}, t.prototype.setPerAction = function (t, e) {
						for (var n in e) n in c[t] && (i.object(e[n]) ? (this.options[t][n] = r(this.options[t][n] || {}, e[n]), i.object(c.perAction[n]) && "enabled" in c.perAction[n] && (this.options[t][n].enabled = !1 !== e[n].enabled)) : i.bool(e[n]) && i.object(c.perAction[n]) ? this.options[t][n].enabled = e[n] : e[n] !== undefined && (this.options[t][n] = e[n]))
					}, t.prototype.getRect = function (t) {
						return t = t || this.target, i.string(this.target) && !i.element(t) && (t = this._context.querySelector(this.target)), d(t)
					}, t.prototype.rectChecker = function (t) {
						return i["function"](t) ? (this.getRect = t, this) : null === t ? (delete this.options.getRect, this) : this.getRect
						...
						if (i.string(e) && -1 !== e.search(" ") && (e = e.trim().split(/ +/)), i.array(e)) {
						...
						if (i.object(e)) {
							for (var u in e) this[t](u, e[u], n);
							return !0
						}
					}, t.prototype.on = function (e, n, r) {
						return this._onOffMultiple("on", e, n, r) ? this : ("wheel" === e && (e = w), x(t.eventTypes, e) ? this.events.on(e, n) : i.string(this.target) ? o.addDelegate(this.target, this._context, e, n, r) : o.add(this.target, e, n, r), this)
					}, t.prototype.off = function (e, n, r) {
						return this._onOffMultiple("off", e, n, r) ? this : ("wheel" === e && (e = w), x(t.eventTypes, e) ? this.events.off(e, n) : i.string(this.target) ? o.removeDelegate(this.target, this._context, e, n, r) : o.remove(this.target, e, n, r), this)
					}, t.prototype.set = function (e) {
						i.object(e) || (e = {}), this.options = r({}, c.base);
						var n = r({}, c.perAction);
						for (var o in s.methodDict) {
							var a = s.methodDict[o];
							this.options[o] = r({}, c[o]), this.setPerAction(o, n), this[a](e[o])
						}
						for (var u = 0; u < t.settingsMethods.length; u++) {
							var p;
							p = t.settingsMethods[u];
							var d = p;
							this.options[d] = c.base[d], d in e && this[d](e[d])
						}
						return l.fire("set", {
							options: e,
							interactable: this
						...
						if (o.remove(this.target, "all"), i.string(this.target))
							for (var t in o.delegatedEvents) {
								var e = o.delegatedEvents[t];
								e.selectors[0] === this.target && e.contexts[0] === this._context && (e.selectors.splice(0, 1), e.contexts.splice(0, 1), e.listeners.splice(0, 1), e.selectors.length || (e[t] = null)), o.remove(this._context, t, o.delegateListener), o.remove(this._context, t, o.delegateUseCapture, !0)
				...
				a.interactables.indexOfElement = function (t, e) {
					...
					for (var n = 0; n < this.length; n++) {
						var i = this[n];
						if (i.target === t && i._context === e) return n
					}
					return -1
					...
					for (var n = 0; n < this.length; n++) {
						...
						var r = o,
							s = void 0;
						if ((i.string(r.target) ? i.element(t) && g(t, r.target) : t === r.target) && r.inContext(t) && (s = e(r)), s !== undefined) return s
					}
				}, S.eventTypes = a.eventTypes = [], S.signals = l, S.settingsMethods = ["deltaSource", "origin", "preventDefault", "rectChecker"], e.exports = S
			}, {
				"./Eventable": 2,
				"./actions/base": 6,
				"./defaultOptions": 18,
		...
		5: [
			function (t, e) {
					...
					return function (e) {
						...
						if (c.supportsTouch && /touch/.test(e.type)) {
							...
							if (!c.supportsPointerEvent && /mouse/.test(e.type)) {
								for (var x = 0; x < s.interactions.length && !y; x++) y = "mouse" !== s.interactions[x].pointerType && s.interactions[x].pointerIsDown;
						...
						for (var w = 0; w < u.length; w++) {
							var S = u[w],
								E = S[0],
								C = S[1];
							C._updateEventTargets(o, r), C[t](E, e, o, r)
						}
					}
				}
				...
				function r(t, e) {
					...
					for (var o in s.delegatedEvents) i(n, o, u.delegateListener), i(n, o, u.delegateUseCapture, !0);
					for (var r in x) i(n, r, x[r])
				}
				var s = t("./scope"),
					a = t("./utils"),
					u = t("./utils/events"),
				...
				for (var v = function () {
					function t(e) {
						var i = e.pointerType;
						n(this, t), this.target = null, this.element = null, this.prepared = {
							name: null,
							axis: null,
							edges: null
							...
							timeStamp: 0
						}, this.downEvent = null, this.downPointer = {}, this._eventTarget = null, this._curEventTarget = null, this.prevEvent = null, this.pointerIsDown = !1, this.pointerWasMoved = !1, this._interacting = !1, this.pointerType = i, d.fire("new", this), s.interactions.push(this)
					}
					return t.prototype.pointerDown = function (t, e, n) {
						...
						this.interacting() || !this.pointerIsDown || this.pointerIds.length < ("gesture" === t.name ? 2 : 1) || (-1 === s.interactions.indexOf(this) && s.interactions.push(this), a.copyAction(this.prepared, t), this.target = e, this.element = n, d.fire("action-start", {
							interaction: this,
							event: this.downEvent
						}))
					}, t.prototype.pointerMove = function (e, n, i) {
						this.simulation || (this.updatePointer(e), a.setCoords(this.curCoords, this.pointers));
						var o = this.curCoords.page.x === this.prevCoords.page.x && this.curCoords.page.y === this.prevCoords.page.y && this.curCoords.client.x === this.prevCoords.client.x && this.curCoords.client.y === this.prevCoords.client.y,
							r = void 0,
							s = void 0;
						this.pointerIsDown && !this.pointerWasMoved && (r = this.curCoords.client.x - this.startCoords.client.x, s = this.curCoords.client.y - this.startCoords.client.y, this.pointerWasMoved = a.hypot(r, s) > t.pointerMoveTolerance);
						var u = {
							pointer: e,
						...
						o || a.setCoordDeltas(this.pointerDelta, this.prevCoords, this.curCoords), d.fire("move", u), o || (this.interacting() && this.doMove(u), this.pointerWasMoved && a.copyCoords(this.prevCoords, this.curCoords))
						...
						t = a.extend({
							...
							interaction: this
						}, t || {}), d.fire("before-action-move", t), this._dontFireMove || d.fire("action-move", t), this._dontFireMove = !1
						...
						t = t || this.prevEvent, this.interacting() && d.fire("action-end", {
							event: t,
							interaction: this
						}), this.stop()
						...
						return -1 === o && (o = this.pointerIds.length, this.pointerIds[o] = i), n && d.fire("update-pointer-down", {
							pointer: t,
							event: e,
							down: n,
							pointerId: i,
						...
						var n = this.getPointerIndex(t); - 1 !== n && (d.fire("remove-pointer", {
							pointer: t,
							event: e,
							pointerIndex: n,
							interaction: this
				...
				var x = {},
					b = c.pEventTypes;
				l.PointerEvent ? (x[b.down] = f.pointerDown, x[b.move] = f.pointerMove, x[b.up] = f.pointerUp, x[b.cancel] = f.pointerUp) : (x.mousedown = f.pointerDown, x.mousemove = f.pointerMove, x.mouseup = f.pointerUp, x.touchstart = f.pointerDown, x.touchmove = f.pointerMove, x.touchend = f.pointerUp, x.touchcancel = f.pointerUp), x.blur = o, d.on("update-pointer-down", function (t) {
					var e = t.interaction,
						n = t.pointer,
						i = t.pointerId,
						o = t.pointerIndex,
						...
						s = t.eventTarget,
						u = t.down;
					e.pointerIds[o] = i, e.pointers[o] = n, u && (e.pointerIsDown = !0), e.interacting() || (a.setCoords(e.startCoords, e.pointers), a.copyCoords(e.curCoords, e.startCoords), a.copyCoords(e.prevCoords, e.startCoords), e.downEvent = r, e.downTimes[o] = e.curCoords.timeStamp, e.downTargets[o] = s || r && a.getEventTargets(r)[0], e.pointerWasMoved = !1, a.pointerExtend(e.downPointer, n))
				}), s.signals.on("add-document", r), s.signals.on("remove-document", r), v.pointerMoveTolerance = 1, v.doOnInteractions = i, v.endAll = o, v.signals = d, v.docEvents = x, s.endAllInteractions = o, e.exports = v
			}, {
				"./scope": 33,
				"./utils": 43,
				"./utils/Signals": 34,
		...
		6: [
			function (t, e) {
				...
				i.signals.on("action-start", function (t) {
					var e = t.interaction,
						i = t.event;
					e._interacting = !0, n(e, i, "start")
				}), i.signals.on("action-move", function (t) {
					var e = t.interaction;
					if (n(e, t.event, "move", t.preEnd), !e.interacting()) return !1
			...
			function (t, e) {
				...
				s.signals.on("before-action-move", function (t) {
					...
					if ("dragmove" === e.type) {
						...
						"x" === i ? (e.pageY = n.startCoords.page.y, e.clientY = n.startCoords.client.y, e.dy = 0) : "y" === i && (e.pageX = n.startCoords.page.x, e.clientX = n.startCoords.client.x, e.dx = 0)
					}
				...
				}, n.drag = u, n.names.push("drag"), i.merge(r.eventTypes, ["dragstart", "dragmove", "draginertiastart", "draginertiaresume", "dragend"]), n.methodDict.drag = "draggable", a.drag = u.defaults, e.exports = u
			}, {
				"../InteractEvent": 3,
				"../Interactable": 4,
				"../Interaction": 5,
			...
			function (t, e) {
				...
				function i(t, e) {
					for (var n = void 0, i = 0; i < t.activeDrops.dropzones.length; i++) {
						...
						r !== n && (e.target = r, o.fire(e)), n = r
					}
				}

				function o(t, e) {
					var i = n(t, e, !0);
					t.activeDrops.dropzones = i.dropzones, t.activeDrops.elements = i.elements, t.activeDrops.rects = [];
					for (var o = 0; o < t.activeDrops.dropzones.length; o++) t.activeDrops.rects[o] = t.activeDrops.dropzones[o].getRect(t.activeDrops.elements[o])
				}
				...
				function s(t, e, n) {
					...
					return t.dropElement !== t.prevDropElement && (t.prevDropTarget && (i.leave = c.extend({
						type: "dragleave"
					}, o), n.dragLeave = i.leave.target = t.prevDropElement, n.prevDropzone = i.leave.dropzone = t.prevDropTarget), t.dropTarget && (i.enter = {
						dragEvent: n,
						interaction: t,
						target: t.dropElement,
						dropzone: t.dropTarget,
						...
						timeStamp: n.timeStamp,
						type: "dragenter"
					}, n.dragEnter = t.dropElement, n.dropzone = t.dropTarget)), "dragend" === n.type && t.dropTarget && (i.drop = c.extend({
						type: "drop"
					}, o), n.dropzone = t.dropTarget, n.relatedTarget = t.dropElement), "dragstart" === n.type && (i.activate = c.extend({
						type: "dropactivate"
					}, o), i.activate.target = null, i.activate.dropzone = null), "dragend" === n.type && (i.deactivate = c.extend({
						type: "dropdeactivate"
					}, o), i.deactivate.target = null, i.deactivate.dropzone = null), "dragmove" === n.type && t.dropTarget && (i.move = c.extend({
						dragmove: n,
						type: "dropmove"
					}, o), n.dropzone = t.dropTarget), i
				}

				function a(t, e) {
					e.leave && t.prevDropTarget.fire(e.leave), e.move && t.dropTarget.fire(e.move), e.enter && t.dropTarget.fire(e.enter), e.drop && t.dropTarget.fire(e.drop), e.deactivate && i(t, e.deactivate), t.prevDropTarget = t.dropTarget, t.prevDropElement = t.dropElement
				}
				var u = t("./base"),
					c = t("../utils"),
					l = t("../scope"),
				...
				h.signals.on("action-start", function (t) {
					var e = t.interaction,
						n = t.event;
					if ("drag" === e.prepared.name) {
						e.activeDrops.dropzones = [], e.activeDrops.elements = [], e.activeDrops.rects = [], e.dropEvents = null, e.dynamicDrop || o(e, e.element);
						var r = e.prevEvent,
							a = s(e, n, r);
					...
					if ("dragmove" === n.type || "dragend" === n.type) {
						var o = e.element,
							a = n,
							u = r(a, i, o);
						e.dropTarget = u.dropzone, e.dropElement = u.element, e.dropEvents = s(e, i, a)
					}
					...
					return c.is.object(t) ? (this.options.drop.enabled = !1 !== t.enabled, c.is["function"](t.ondrop) && (this.events.ondrop = t.ondrop), c.is["function"](t.ondropactivate) && (this.events.ondropactivate = t.ondropactivate), c.is["function"](t.ondropdeactivate) && (this.events.ondropdeactivate = t.ondropdeactivate), c.is["function"](t.ondragenter) && (this.events.ondragenter = t.ondragenter), c.is["function"](t.ondragleave) && (this.events.ondragleave = t.ondragleave), c.is["function"](t.ondropmove) && (this.events.ondropmove = t.ondropmove), /^(pointer|center)$/.test(t.overlap) ? this.options.drop.overlap = t.overlap : c.is.number(t.overlap) && (this.options.drop.overlap = Math.max(Math.min(1, t.overlap), 0)), "accept" in t && (this.options.drop.accept = t.accept), "checker" in t && (this.options.drop.checker = t.checker), this) : c.is.bool(t) ? (this.options.drop.enabled = t, t || (this.ondragenter = this.ondragleave = this.ondrop = this.ondropactivate = this.ondropdeactivate = null), this) : this.options.drop
				}, f.prototype.dropCheck = function (t, e, n, i, o, r) {
					var s = !1;
					if (!(r = r || this.getRect(o))) return !!this.options.drop.checker && this.options.drop.checker(t, e, s, this, o, n, i);
					...
					return this.options.drop.checker && (s = this.options.drop.checker(t, e, s, this, o, n, i)), s
				}, f.signals.on("unset", function (t) {
					t.interactable.dropzone(!1)
				}), f.settingsMethods.push("dropChecker"), h.signals.on("new", function (t) {
					...
					return c.is.bool(t) ? (m = t, p) : m
				}, c.merge(f.eventTypes, ["dragenter", "dragleave", "dropactivate", "dropdeactivate", "dropmove", "drop"]), u.methodDict.drop = "dropzone", g.drop = v.defaults, e.exports = v
			}, {
				"../InteractEvent": 3,
				"../Interactable": 4,
				"../Interaction": 5,
		...
		9: [
			function (t, e) {
				...
				o.signals.on("new", function (t) {
					...
					var e = t.iEvent,
						n = t.interaction;
					"gesturemove" === e.type && (e.ds = e.scale - n.gesture.scale, n.target.fire(e), n.gesture.prevAngle = e.angle, n.gesture.prevDistance = e.distance, e.scale === Infinity || null === e.scale || e.scale === undefined || isNaN(e.scale) || (n.gesture.scale = e.scale))
					...
					if ("gesture" === r) {
						var l = e.pointers;
						n.touches = [l[0], l[1]], a ? (n.distance = i.touchDistance(l, c), n.box = i.touchBBox(l), n.scale = 1, n.ds = 0, n.angle = i.touchAngle(l, undefined, c), n.da = 0) : u || s instanceof o ? (n.distance = e.prevEvent.distance, n.box = e.prevEvent.box, n.scale = e.prevEvent.scale, n.ds = n.scale - 1, n.angle = e.prevEvent.angle, n.da = n.angle - e.gesture.startAngle) : (n.distance = i.touchDistance(l, c), n.box = i.touchBBox(l), n.scale = n.distance / e.gesture.startDistance, n.angle = i.touchAngle(l, e.gesture.prevAngle, c), n.ds = n.scale - e.gesture.prevScale, n.da = n.angle - e.gesture.prevAngle)
					}
				...
				}), n.gesture = u, n.names.push("gesture"), i.merge(r.eventTypes, ["gesturestart", "gesturemove", "gestureend"]), n.methodDict.gesture = "gesturable", a.gesture = u.defaults, e.exports = u
			}, {
				"../InteractEvent": 3,
				"../Interactable": 4,
				"../Interaction": 5,
			...
			function (t, e) {
				...
				function n(t, e, n, i, r, s, a) {
					...
					if (!0 === e) {
						...
						if (u < 0 && ("left" === t ? t = "right" : "right" === t && (t = "left")), c < 0 && ("top" === t ? t = "bottom" : "bottom" === t && (t = "top")), "left" === t) return n.x < (u >= 0 ? s.left : s.right) + a;
				...
				var i = t("./base"),
					...
					p = {
						...
						checker: function (t, e, i, r, s, a) {
							...
							if (c.resize.enabled) {
								...
								if (o.is.object(p.edges)) {
									for (var f in d) d[f] = n(f, p.edges[f], u, s._eventTarget, r, a, p.margin || l);
						...
						getCursor: function (t) {
							...
							if (t.edges) {
								for (var e = "", n = ["top", "bottom", "left", "right"], i = 0; i < 4; i++) t.edges[n[i]] && (e += n[i]);
								return p.cursors[e]
							}
						}
					};
				s.signals.on("new", function (t) {
					...
					if ("resizestart" === e.type && n.prepared.edges) {
						...
						r.preserveAspectRatio && (n.resizeStartAspectRatio = i.width / i.height), n.resizeRects = {
							start: i,
							current: o.extend({}, i),
							inverted: o.extend({}, i),
							previous: o.extend({}, i),
					...
					if ("move" === n && i.prepared.edges) {
						...
						if (r.preserveAspectRatio || r.square) {
							...
							u = i.prepared._linkedEdges, h.left && h.bottom || h.right && h.top ? v = -g / m : h.left || h.right ? v = g / m : (h.top || h.bottom) && (g = v * m)
						}
						if (u.top && (l.top += v), u.bottom && (l.bottom += v), u.left && (l.left += g), u.right && (l.right += g), a) {
							if (o.extend(p, l), "reposition" === s) {
								var y = void 0;
								p.top > p.bottom && (y = p.top, p.top = p.bottom, p.bottom = y), p.left > p.right && (y = p.left, p.left = p.right, p.right = y)
							}
						} else p.top = Math.min(l.top, c.bottom), p.bottom = Math.max(l.bottom, c.top), p.left = Math.min(l.left, c.right), p.right = Math.max(l.right, c.left);
						p.width = p.right - p.left, p.height = p.bottom - p.top;
						for (var x in p) d[x] = p[x] - f[x];
						e.edges = i.prepared.edges, e.rect = p, e.deltaRect = d
					}
				}), a.prototype.resizable = function (t) {
					return o.is.object(t) ? (this.options.resize.enabled = !1 !== t.enabled, this.setPerAction("resize", t), this.setOnEvents("resize", t), /^x$|^y$|^xy$/.test(t.axis) ? this.options.resize.axis = t.axis : null === t.axis && (this.options.resize.axis = c.resize.axis), o.is.bool(t.preserveAspectRatio) ? this.options.resize.preserveAspectRatio = t.preserveAspectRatio : o.is.bool(t.square) && (this.options.resize.square = t.square), this) : o.is.bool(t) ? (this.options.resize.enabled = t, t || (this.onresizestart = this.onresizestart = this.onresizeend = null), this) : this.options.resize
				...
				}), i.resize = p, i.names.push("resize"), o.merge(a.eventTypes, ["resizestart", "resizemove", "resizeinertiastart", "resizeinertiaresume", "resizeend"]), i.methodDict.resize = "resizable", c.resize = p.defaults, e.exports = p
			}, {
				"../InteractEvent": 3,
				"../Interactable": 4,
				"../Interaction": 5,
			...
			function (t, e) {
				...
				var n = t("./utils/raf"),
					...
					u = {
						...
						prevTime: 0,
						start: function (t) {
							u.isScrolling = !0, n.cancel(u.i), u.interaction = t, u.prevTime = (new Date).getTime(), u.i = n.request(u.scroll)
						},
						stop: function () {
							u.isScrolling = !1,
							n.cancel(u.i)
						...
						scroll: function () {
							var t = u.interaction.target.options[u.interaction.prepared.name].autoScroll,
								...
								s = (r - u.prevTime) / 1e3,
								a = t.speed * s;
							a >= 1 && (o.window(e) ? e.scrollBy(u.x * a, u.y * a) : e && (e.scrollLeft += u.x * a), u.prevTime = r), u.isScrolling && (n.cancel(u.i), u.i = n.request(u.scroll))
						},
						check: function (t, e) {
							var n = t.options;
						...
						onInteractionMove: function (t) {
							...
							if (e.interacting() && u.check(e.target, e.prepared.name)) {
								if (e.simulation) return void(u.x = u.y = 0);
								var s = void 0,
									a = void 0,
									c = void 0,
									l = void 0,
								...
								if (o.window(d)) l = n.clientX < u.margin, s = n.clientY < u.margin, a = n.clientX > d.innerWidth - u.margin, c = n.clientY > d.innerHeight - u.margin;
								else {
									var f = r.getElementClientRect(d);
									l = n.clientX < f.left + u.margin, s = n.clientY < f.top + u.margin, a = n.clientX > f.right - u.margin, c = n.clientY > f.bottom - u.margin
								}
								u.x = a ? 1 : l ? -1 : 0, u.y = c ? 1 : s ? -1 : 0, u.isScrolling || (u.margin = p.margin, u.speed = p.speed, u.start(e))
							}
						}
					};
				s.signals.on("stop-active", function () {
					u.stop()
				}), s.signals.on("action-move", u.onInteractionMove), a.perAction.autoScroll = u.defaults, e.exports = u
			}, {
				"./Interaction": 5,
				"./defaultOptions": 18,
				"./utils/domUtils": 38,
		...
		12: [
			function (t) {
				...
				e.prototype.getAction = function (t, e, n, i) {
				...
				}, "Interactable.ignoreForm() has been deprecated. Use Interactble.draggable({ignoreFrom: newValue})."), e.prototype.allowFrom = s(function (t) {
					return this._backCompatOption("allowFrom", t)
				}, "Interactable.allowForm() has been deprecated. Use Interactble.draggable({allowFrom: newValue})."), e.prototype.testIgnore = function (t, e, n) {
					...
					return i["function"](t) ? (this.options.actionChecker = t, this) : null === t ? (delete this.options.actionChecker, this) : this.options.actionChecker
				}, e.prototype.styleCursor = function (t) {
					return i.bool(t) ? (this.options.styleCursor = t, this) : null === t ? (delete this.options.styleCursor, this) : this.options.styleCursor
					...
					for (var r = this.getRect(o), s = e.buttons || {
						...
						c = n.names[u];
						var l = c;
						if ((!i.pointerIsDown || !/mouse|pointer/.test(i.pointerType) || 0 != (s & this.options[l].mouseButtons)) && (a = n[l].checker(t, e, this, o, i, r))) return a
					}
				}
			}, {
				"../Interactable": 4,
			...
			function (t, e) {
				...
				function o(t, e, n, o) {
					...
					for (var s = [], a = [], u = o; f.is.element(u);) {
						s = [], a = [], d.interactables.forEachMatch(u, r);
						var c = i(t, e, n, s, a, o);
						if (c.action && !c.target.options[c.action.name].manualStart) return c;
						u = f.parentNode(u)
					}
					return {}
				}
				...
				function r(t, e) {
					var n = e.action,
						i = e.target,
						o = e.element;
					if (n = n || {}, t.target && t.target.options.styleCursor && (t.target._doc.documentElement.style.cursor = ""), t.target = i, t.element = o, f.copyAction(t.prepared, n), i && i.options.styleCursor) {
					...
					if (o && r && g.maxInteractions) {
						for (var c = 0; c < d.interactions.length; c++) {
							...
							var p = l,
								f = p.prepared.name;
							if (p.interacting()) {
								if (++s >= g.maxInteractions) return !1;
								if (p.target === t) {
									if ((a += f === n.name | 0) >= o) return !1;
									if (p.element === e && (u++, f !== n.name || u >= r)) return !1
								}
							}
						}
				...
				c.signals.on("down", function (t) {
					...
					return f.is.number(t) ? (g.maxInteractions = t, a) : g.maxInteractions
				}, u.settingsMethods.push("styleCursor"), u.settingsMethods.push("actionChecker"), u.settingsMethods.push("ignoreFrom"), u.settingsMethods.push("allowFrom"), p.base.actionChecker = null, p.base.styleCursor = !0, f.extend(p.perAction, g.defaults.perAction), e.exports = g
			}, {
				"../Interactable": 4,
				"../Interaction": 5,
				"../actions/base": 6,
		...
		14: [
			function (t) {
				...
				var n = t("./base"),
					...
					r = t("../utils/domUtils"),
					s = r.parentNode;
				n.setActionDefaults(t("../actions/drag")), n.signals.on("before-start", function (t) {
					var r = t.interaction,
						a = t.eventTarget,
						u = t.dx,
						c = t.dy;
					if ("drag" === r.prepared.name) {
						var l = Math.abs(u),
							...
							f = d.startAxis,
							h = l > p ? "x" : l < p ? "y" : "xy";
						if (r.prepared.axis = "start" === d.lockAxis ? h[0] : d.lockAxis, "xy" !== h && "xy" !== f && f !== h) {
							...
							for (var g = a, v = function (t) {
								if (t !== r.target) {
									...
									if (!i.manualStart && t.testIgnoreAllow(i, g, a)) {
										...
										if (o && "drag" === o.name && e(h, t) && n.validateAction(o, t, g, a)) return t
									}
								}
							}; o.element(g);) {
								var m = i.interactables.forEachMatch(g, v);
								if (m) {
									r.prepared.name = "drag", r.target = m, r.element = g;
									break
								}
								g = s(g)
							}
		...
		20: [
			function (t) {
				...
				function e(t, e) {
					...
					e.x0 = t.prevEvent.pageX, e.y0 = t.prevEvent.pageY, e.t0 = e.startEvent.timeStamp / 1e3, e.sx = e.sy = 0, e.modifiedXe = e.xe = (e.vx0 - o) / i, e.modifiedYe = e.ye = (e.vy0 - o) / i, e.te = o, e.lambda_v0 = i / e.v0, e.one_ve_v0 = 1 - n.endSpeed / e.v0
				}

				function n() {
					o(this), u.setCoordDeltas(this.pointerDelta, this.prevCoords, this.curCoords);
					...
					if (i < t.te) {
						...
						this.doMove(), t.i = c.request(this.boundInertiaFrame)
				...
				function i() {
					...
					e < n ? (t.sx = u.easeOutQuad(e, 0, t.xe, n), t.sy = u.easeOutQuad(e, 0, t.ye, n), this.pointerMove(t.startEvent, t.startEvent), t.i = c.request(this.boundSmoothEndFrame)) : (t.sx = t.xe, t.sy = t.ye, this.pointerMove(t.startEvent, t.startEvent), this.end(t.startEvent), t.smoothEnd = t.active = !1, this.simulation = null)
				}
				...
				s.signals.on("new", function (t) {
					...
					if (l.active)
						for (var p = o; u.is.element(p);) {
							if (p === e.element) {
								c.cancel(l.i), l.active = !1, e.simulation = null, e.updatePointer(i), u.setCoords(e.curCoords, e.pointers);
								var d = {
									interaction: e
								};
								s.signals.fire("before-action-move", d), s.signals.fire("action-resume", d);
								var f = new r(e, n, e.prepared.name, "inertiaresume", e.element);
								e.target.fire(f), e.prevEvent = f, a.resetStatuses(e.modifierStatuses), u.copyCoords(e.prevCoords, e.curCoords);
								break
							}
							p = u.parentNode(p)
						}
					...
					if (n.interacting() && !o.active) {
						...
						y && !x && (a.resetStatuses(f), m = a.setAll(b), m.shouldMove && m.locked && (v = !0)), (x || v) && (u.copyCoords(o.upCoords, n.curCoords), n.pointers[0] = o.startEvent = new r(n, i, n.prepared.name, "inertiastart", n.element), o.t0 = d, o.active = !0, o.allowResume = p.allowResume, n.simulation = o, s.fire(o.startEvent), x ? (o.vx0 = n.pointerDelta.client.vx, o.vy0 = n.pointerDelta.client.vy, o.v0 = g, e(n, o), u.extend(h, n.curCoords.page), h.x += o.xe, h.y += o.ye, a.resetStatuses(f), m = a.setAll(b), o.modifiedXe += m.dx, o.modifiedYe += m.dy, o.i = c.request(n.boundInertiaFrame)) : (o.smoothEnd = !0, o.xe = m.dx, o.ye = m.dy, o.sx = o.sy = 0, o.i = c.request(n.boundSmoothEndFrame)))
					}
				}), s.signals.on("stop-active", function (t) {
					var e = t.interaction,
						n = e.inertiaStatus;
					n.active && (c.cancel(n.i), n.active = !1, e.simulation = null)
				})
			}, {
				"./InteractEvent": 3,
				"./Interaction": 5,
		...
		21: [
			function (t, e) {
				...
				function n(t, e) {
					...
					return n || (n = new a(t, e), n.events.global = c), n
				}
				...
				n.isSet = function (t, e) {
					...
					if (r.is.string(t) && -1 !== t.search(" ") && (t = t.trim().split(/ +/)), r.is.array(t)) {
					...
					} else o.remove(s.document, t, e, i);
					return n
				}, n.debug = function () {
					return s
				}, n.getPointerAverage = r.pointerAverage, n.getTouchBBox = r.touchBBox, n.getTouchDistance = r.touchDistance, n.getTouchAngle = r.touchAngle, n.getElementRect = r.getElementRect, n.getElementClientRect = r.getElementClientRect, n.matchesSelector = r.matchesSelector, n.closest = r.closest, n.supportsTouch = function () {
					...
					return r.is.number(t) ? (u.pointerMoveTolerance = t, n) : u.pointerMoveTolerance
				}, n.addDocument = s.addDocument, n.removeDocument = s.removeDocument, s.interact = n, e.exports = n
			}, {
				"./Interactable": 4,
				"./Interaction": 5,
				"./scope": 33,
		...
		22: [
			function (t) {
				...
				n.prototype.preventDefault = function (t) {
					return /^(always|never|auto)$/.test(t) ? (this.options.preventDefault = t, this) : r.bool(t) ? (this.options.preventDefault = t ? "always" : "never", this) : this.options.preventDefault
				}, n.prototype.checkAndPreventDefault = function (t) {
					var e = this.options.preventDefault;
					if ("never" !== e) return "always" === e ? void t.preventDefault() : void(s.supportsOptions && /^touch(start|move)$/.test(t.type) || /^(mouse|pointer|touch)*(down|start)/i.test(t.type) || r.element(t.target) && c(t.target, "input,select,textarea,[contenteditable=true],[contenteditable=true] *") || t.preventDefault())
				};
				...
				i.docEvents.dragstart = function (t) {
					for (var e = 0; e < o.interactions.length; e++) {
						...
						n = o.interactions[e];
						var i = n;
						if (i.element && (i.element === t.target || u(i.element, t.target))) return void i.target.checkAndPreventDefault(t)
					}
				}
			}, {
				"./Interactable": 4,
			...
			function (t, e) {
					...
					s = {
						...
						setOffsets: function (t) {
							var e = t.interaction,
								...
								r = e.startOffset,
								a = i.getRect(o);
							a ? (r.left = n.x - a.left, r.top = n.y - a.top, r.right = a.right - n.x, r.bottom = a.bottom - n.y, "width" in a || (a.width = a.right - a.left), "height" in a || (a.height = a.bottom - a.top)) : r.left = r.top = r.right = r.bottom = 0, t.rect = a, t.interactable = i, t.element = o;
							for (var u = 0; u < s.names.length; u++) {
								var c;
								c = s.names[u];
								var l = c;
								t.options = i.options[e.prepared.name][l], t.options && (e.modifierOffsets[l] = s[l].setOffset(t))
							}
						},
						setAll: function (t) {
							var e = t.interaction,
							...
							for (var c = 0; c < s.names.length; c++) {
								...
								n(f, o, a) && (t.status = t.status = i[p], t.options = f, t.offset = t.interaction.modifierOffsets[p], d.set(t), t.status.locked && (t.modifiedCoords.x += t.status.dx, t.modifiedCoords.y += t.status.dy, u.dx += t.status.dx, u.dy += t.status.dy, u.locked = !0))
							}
						...
						resetStatuses: function (t) {
							for (var e = 0; e < s.names.length; e++) {
								...
								var i = n,
									o = t[i] || {};
								o.dx = o.dy = 0, o.modifiedX = o.modifiedY = NaN, o.locked = !1, o.changed = !0, t[i] = o
							}
							return t
						},
						start: function (t, e) {
							...
							s.setOffsets(i), s.resetStatuses(i.statuses), i.pageCoords = r({}, n.startCoords.page), n.modifierResult = s.setAll(i)
						},
						beforeMove: function (t) {
							...
							!o.shouldMove && i && (e._dontFireMove = !0), e.modifierResult = o
						},
						end: function (t) {
						...
						setXY: function (t) {
							for (var e = t.iEvent, n = t.interaction, i = r({}, t), o = 0; o < s.names.length; o++) {
								var a = s.names[o];
								if (i.options = n.target.options[n.prepared.name][a], i.options) {
									var u = s[a];
									i.status = n.modifierStatuses[a], e[a] = u.modifyCoords(i)
								}
							}
						}
					};
				o.signals.on("new", function (t) {
					t.startOffset = {
						...
						top: 0,
						bottom: 0
					}, t.modifierOffsets = {}, t.modifierStatuses = s.resetStatuses({}), t.modifierResult = null
				}), o.signals.on("action-start", s.start), o.signals.on("action-resume", s.start), o.signals.on("before-action-move", s.beforeMove), o.signals.on("action-end", s.end), i.signals.on("set-xy", s.setXY), e.exports = s
			}, {
				"../InteractEvent": 3,
				"../Interaction": 5,
				"../utils/extend": 40
		...
		24: [
			function (t, e) {
					...
					s = {
						...
						setOffset: function (t) {
							var e = t.rect,
								...
								o = i && i.elementRect,
								r = {};
							return e && o ? (r.left = n.left - e.width * o.left, r.top = n.top - e.height * o.top, r.right = n.right - e.width * (1 - o.right), r.bottom = n.bottom - e.height * (1 - o.bottom)) : r.left = r.top = r.right = r.bottom = 0, r
						},
						set: function (t) {
							...
							"string" != typeof u && ("x" in u && "y" in u ? (l = Math.max(Math.min(c.x + c.width - d.right, a.x), c.x + d.left), p = Math.max(Math.min(c.y + c.height - d.bottom, a.y), c.y + d.top)) : (l = Math.max(Math.min(c.right - d.right, a.x), c.left + d.left), p = Math.max(Math.min(c.bottom - d.bottom, a.y), c.top + d.top)), r.dx = l - a.x, r.dy = p - a.y, r.changed = r.modifiedX !== l || r.modifiedY !== p, r.locked = !(!r.dx && !r.dy), r.modifiedX = l, r.modifiedY = p)
						},
						modifyCoords: function (t) {
							var e = t.page,
								...
								r = t.options,
								s = r && r.elementRect;
							if (r && r.enabled && ("start" !== o || !s || !i.locked) && i.locked) return e.x += i.dx, e.y += i.dy, n.x += i.dx, n.y += i.dy, {
								dx: i.dx,
								dy: i.dy
							}
						},
				...
				i.restrict = s, i.names.push("restrict"), r.perAction.restrict = s.defaults, e.exports = s
			}, {
				"../defaultOptions": 18,
				"../utils": 43,
				"./base": 23
		...
		25: [
			function (t, e) {
						...
						set: function (t) {
							...
							if (n.interacting() && p) {
								var d = r.useStatusXY ? {
									...
									g = d.x,
									v = d.y;
								r.dx = 0, r.dy = 0, r.locked = !1, p.top ? v = Math.min(Math.max(h.top + s.top, d.y), f.top + s.top) : p.bottom && (v = Math.max(Math.min(h.bottom - s.bottom, d.y), f.bottom - s.bottom)), p.left ? g = Math.min(Math.max(h.left + s.left, d.x), f.left + s.left) : p.right && (g = Math.max(Math.min(h.right - s.right, d.x), f.right - s.right)), r.dx = g - d.x, r.dy = v - d.y, r.changed = r.modifiedX !== g || r.modifiedY !== v, r.locked = !(!r.dx && !r.dy), r.modifiedX = g, r.modifiedY = v
							}
						},
						modifyCoords: function (t) {
							var e = t.page,
								...
								o = t.phase,
								r = t.options;
							if (r && r.enabled && ("start" !== o || !i.locked) && i.locked) return e.x += i.dx, e.y += i.dy, n.x += i.dx, n.y += i.dy, {
								dx: i.dx,
								dy: i.dy
							}
						},
				...
				n.restrictEdges = p, n.names.push("restrictEdges"), r.perAction.restrictEdges = p.defaults, s.defaults.restrictEdges = p.defaults, e.exports = p
			}, {
				"../actions/resize": 10,
				"../defaultOptions": 18,
				"../utils": 43,
					...
					l = {
						...
						set: function (t) {
							...
							if (e.interacting() && s) {
								...
								}, s.top ? (t.options.inner.top = a.bottom - l.height, t.options.outer.top = a.bottom - p.height) : s.bottom && (t.options.inner.bottom = a.top + l.height, t.options.outer.bottom = a.top + p.height), s.left ? (t.options.inner.left = a.right - l.width, t.options.outer.left = a.right - p.width) : s.right && (t.options.inner.right = a.left + l.width, t.options.outer.right = a.left + p.width), i.set(t)
							}
						},
						modifyCoords: i.modifyCoords
					};
				n.restrictSize = l, n.names.push("restrictSize"), s.perAction.restrictSize = l.defaults, a.defaults.restrictSize = l.defaults, e.exports = l
			}, {
				"../actions/resize": 10,
				"../defaultOptions": 18,
				"../utils": 43,
		...
		27: [
			function (t, e) {
					...
					s = {
						...
						set: function (t) {
							...
							if (i.useStatusXY) c = {
								...
								c = o.extend({}, n), c.x -= p.x, c.y -= p.y
							}
							i.realX = c.x, i.realY = c.y;
							for (var d = r.targets ? r.targets.length : 0, f = 0; f < s.length; f++) {
								...
								for (var g = h, v = g.x, m = g.y, y = c.x - v, x = c.y - m, b = 0; b < r.targets.length; b++) {
									...
									w = r.targets[b];
									var S = w;
									u = o.is["function"](S) ? S(y, x, e) : S, u && a.push({
							...
							for (l = 0, d = a.length; l < d; l++) {
								...
								var C = u.range,
									...
									I = o.hypot(T, _),
									M = I <= C;
								C === Infinity && E.inRange && E.range !== Infinity && (M = !1), E.target && !(M ? E.inRange && C !== Infinity ? I / C < E.distance / E.range : C === Infinity && E.range !== Infinity || I < E.distance : !E.inRange && I < E.distance) || (E.target = u, E.distance = I, E.range = C, E.inRange = M, E.dx = T, E.dy = _, i.range = C)
							}
							var O = void 0;
							E.target ? (O = i.modifiedX !== E.target.x || i.modifiedY !== E.target.y, i.modifiedX = E.target.x, i.modifiedY = E.target.y) : (O = !0, i.modifiedX = NaN, i.modifiedY = NaN), i.dx = E.dx, i.dy = E.dy, i.changed = O || E.inRange && !i.locked, i.locked = E.inRange
						},
						modifyCoords: function (t) {
							var e = t.page,
								n = t.client,
							...
							if (r && r.enabled && ("start" !== o || !s || !s.length)) return i.locked && (e.x += i.dx, e.y += i.dy, n.x += i.dx, n.y += i.dy), {
								range: i.range,
								locked: i.locked,
								x: i.modifiedX,
								y: i.modifiedY,
				...
				i.createSnapGrid = function (t) {
					return function (e, n) {
						var i = t.limits || {
							...
							r = 0,
							s = 0;
						o.is.object(t.offset) && (r = t.offset.x, s = t.offset.y);
				...
				}, n.snap = s, n.names.push("snap"), r.perAction.snap = s.defaults, e.exports = s
			}, {
				"../defaultOptions": 18,
				"../interact": 21,
				"../utils": 43,
		...
		28: [
			function (t, e) {
					...
					a = {
						...
						set: function (t) {
							...
							for (var l = 0; l < n.targets.length; l++) {
								...
								var d = p,
									f = void 0;
								f = s.is["function"](d) ? d(u, c, e) : d, f && ("width" in f && "height" in f && (f.x = f.width, f.y = f.height), t.options.targets.push(f))
							}
							i.set(t)
						},
						modifyCoords: function (t) {
				...
				n.snapSize = a, n.names.push("snapSize"), o.perAction.snapSize = a.defaults, r.defaults.snapSize = a.defaults, e.exports = a
			}, {
				"../actions/resize": 10,
				"../defaultOptions": 18,
				"../utils/": 43,
			...
			function (t, e) {
				...
				e.exports = function () {
					function t(e, o, r, s, a) {
						if (n(this, t), i.pointerExtend(this, r), r !== o && i.pointerExtend(this, o), this.interaction = a, this.timeStamp = (new Date).getTime(), this.originalEvent = r, this.type = e, this.pointerId = i.getPointerId(o), this.pointerType = i.getPointerType(o), this.target = s, this.currentTarget = null, "tap" === e) {
						...
						} else "doubletap" === e && (this.dt = o.timeStamp - a.tapTime)
					}
		...
		30: [
			function (t, e) {
				...
				function i(t) {
					...
					if ("tap" === r && (e.pointerWasMoved || !e.downTargets[s] || e.downTargets[s] !== o)) return [];
					for (var u = a.getPath(o), l = {
						...
						d = u[p];
						var f = d;
						l.element = f, c.fire("collect-targets", l)
					}
				...
				s.signals.on("update-pointer-down", function (t) {
					...
					s || e.pointerIsDown && !e.pointerWasMoved || (e.pointerIsDown && clearTimeout(e.holdTimers[a].timeout), n({
						interaction: e,
						pointer: i,
						event: o,
						eventTarget: r,
					...
					for (var e = t.interaction, i = t.pointer, o = t.event, r = t.eventTarget, s = t.pointerIndex, u = e.holdTimers[s], l = a.getPath(r), p = {
						...
						f = l[d];
						var h = f;
						p.element = h, c.fire("collect-targets", p)
					}
					if (p.targets.length) {
						...
						u.duration = g, u.timeout = setTimeout(function () {
							n({
								interaction: e,
								eventTarget: r,
								pointer: i,
				...
				for (var v = 0; v < l.length; v++) s.signals.on(l[v], o(p[v]));
				s.signals.on("new", function (t) {
					t.prevTap = null, t.tapTime = 0, t.holdTimers = []
				}), u.pointerEvents = d.defaults, e.exports = d
			}, {
				"../Interaction": 5,
				"../defaultOptions": 18,
				"../utils": 43,
		...
		31: [
			function (t, e) {
				...
				var r = t("./base"),
					s = t("../Interaction");
				r.signals.on("new", n), r.signals.on("fired", i);
		...
		32: [
			function (t) {
				...
				e.signals.on("collect-targets", function (t) {
					...
					var n = t.interactable,
						i = t.options;
					r(n.events.options, e.defaults), r(n.events.options, i)
				}), a(n.eventTypes, e.types), n.prototype.pointerEvents = function (t) {
					return r(this.events.options, t), this
				};
				...
				var n = t("./utils"),
					...
					a = {
						...
						addDocument: function (t, e) {
							if (n.contains(a.documents, t)) return !1;
							e = e || s(t), a.documents.push(t), i.documents.push(t), t !== a.document && i.add(e, "unload", a.onWindowUnload), o.fire("add-document", {
								doc: t,
								win: e
							})
						},
						removeDocument: function (t, e) {
							...
							e = e || s(t), i.remove(e, "unload", a.onWindowUnload), a.documents.splice(n, 1), i.documents.splice(n, 1), o.fire("remove-document", {
								win: e,
								doc: t
							})
						},
		...
		36: [
			function (t, e) {
				...
				u.isOperaMobile = "Opera" === a.appName && u.supportsTouch && a.userAgent.match("Presto"), e.exports = u
			}, {
				"./domObjects": 37,
				"./is": 45,
				"./window": 51
		...
		37: [
			function (t, e) {
				...
				var i = {},
					o = t("./window").window;
				i.document = o.document, i.DocumentFragment = o.DocumentFragment || n, i.SVGElement = o.SVGElement || n, i.SVGSVGElement = o.SVGSVGElement || n, i.SVGElementInstance = o.SVGElementInstance || n, i.Element = o.Element || n, i.HTMLElement = o.HTMLElement || i.Element, i.Event = o.Event, i.Touch = o.Touch || n, i.PointerEvent = o.PointerEvent || o.MSPointerEvent, e.exports = i
			}, {
				"./window": 51
			}
		],
				...
				var n = t("./window"),
					...
					s = {
						...
						matchesSelector: function (t, e) {
							return n.window !== n.realWindow && (e = e.replace(/\/deep\//g, " ")), t[i.prefixedMatchesSelector](e)
						},
									...
									if (o) {
										if (i.parentNode !== i.ownerDocument)
											if (o.parentNode !== i.ownerDocument) {
												if (!e.length)
													for (a = o; a.parentNode && a.parentNode !== a.ownerDocument;) e.unshift(a), a = a.parentNode;
												if (o instanceof r.HTMLElement && i instanceof r.SVGElement && !(i instanceof r.SVGSVGElement)) {
													if (i === o.parentNode) continue;
													a = i.ownerSVGElement
												} else a = i;
						...
						matchesUpTo: function (t, e, n) {
							for (; o.element(t);) {
								...
								if ((t = s.parentNode(t)) === n) return s.matchesSelector(t, e)
							}
							return !1
						},
						...
						getPath: function (t) {
							for (var e = []; t;) e.push(t), t = s.parentNode(t);
							return e
						},
						trySelector: function (t) {
							return !!o.string(t) && (r.document.querySelector(t), !0)
						}
					};
				e.exports = s
			}, {
			...
			function (t, e) {
				...
				function n(t, e, n, i) {
					...
					s || (s = {
						events: {},
						typeCount: 0
					}, r = y.push(t) - 1, x.push(s)), s.events[e] || (s.events[e] = [], s.typeCount++), m(s.events[e], n) || (t.addEventListener(e, n, S ? o : !!o.capture), s.events[e].push(n))
				}
					...
					if (a && a.events)
						if ("all" !== e) {
							if (a.events[e]) {
								...
								if ("all" === n) {
									for (var l = 0; l < u; l++) i(t, e, a.events[e][l], r);
									return
								}
								for (var p = 0; p < u; p++)
									if (a.events[e][p] === n) {
										t.removeEventListener("on" + e, n, S ? r : !!r.capture), a.events[e].splice(p, 1);
										break
									}
								a.events[e] && 0 === a.events[e].length && (a.events[e] = null, a.typeCount--)
							}
							a.typeCount || (x.splice(s, 1), y.splice(s, 1))
						} else
				...
				function o(t, e, i, o, r) {
					...
					var d = b[i],
						f = void 0;
					for (f = d.selectors.length - 1; f >= 0 && (d.selectors[f] !== t || d.contexts[f] !== e); f--); - 1 === f && (f = d.selectors.length, d.selectors.push(t), d.contexts.push(e), d.listeners.push([])), d.listeners[f].push([o, !!u.capture, u.passive])
				}
							...
							if (l.selectors[d] === t && l.contexts[d] === e) {
								for (var f = l.listeners[d], h = f.length - 1; h >= 0; h--) {
									...
									if (v === o && m === !!u.capture && y === u.passive) {
										f.splice(h, 1), f.length || (l.selectors.splice(d, 1), l.contexts.splice(d, 1), l.listeners.splice(d, 1), i(e, n, s), i(e, n, a, !0), l.selectors.length || (b[n] = null)), p = !0;
										break
									}
								}
								if (p) break
				...
				function s(t, e) {
					var n = c(e),
						...
						s = r[0],
						a = s;
					for (f(i, t), i.originalEvent = t, i.preventDefault = u; l.element(a);) {
		...
		43: [
			function (t, e) {
				...
				n(o, t("./arr")), n(o, t("./domUtils")), n(o, t("./pointerUtils")), n(o, t("./rect")), e.exports = o
			}, {
				"./arr": 35,
				"./domUtils": 38,
				"./extend": 40,
					...
					o = {
						...
						mouseOrPen: function (t) {
							...
							for (var s = void 0, a = 0; a < n.interactions.length; a++) {
								...
								var c = u;
								if (c.pointerType === o) {
									if (c.simulation && !i.contains(c.pointerIds, e)) continue;
							...
							for (var l = 0; l < n.interactions.length; l++) {
								...
								p = n.interactions[l];
								var d = p;
								if (!(d.pointerType !== o || /down/i.test(r) && d.simulation)) return d
							}
							return null
						},
						...
						idle: function (t) {
							for (var e = t.pointerType, i = 0; i < n.interactions.length; i++) {
								...
								} else if (r.pointerIds.length >= 2) continue;
			...
			function (t, e) {
				...
				var n = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
					...
					r = {
						...
						element: function (t) {
							if (!t || "object" !== (void 0 === t ? "undefined" : n(t))) return !1;
				...
				var n = t("./hypot"),
					...
					c = {
						...
						setCoordDeltas: function (t, e, i) {
							...
							t.page.speed = n(t.page.x, t.page.y) / o, t.page.vx = t.page.x / o, t.page.vy = t.page.y / o, t.client.speed = n(t.client.x, t.page.y) / o, t.client.vx = t.client.x / o, t.client.vy = t.client.y / o
						},
						...
						getPageXY: function (t, e) {
							return e = e || {}, i.isOperaMobile && c.isNativePointer(t) ? (c.getXY("screen", t, e), e.x += window.scrollX, e.y += window.scrollY) : c.getXY("page", t, e), e
						},
						getClientXY: function (t, e) {
							return e = e || {}, i.isOperaMobile && c.isNativePointer(t) ? c.getXY("screen", t, e) : c.getXY("client", t, e), e
						},
						...
						setCoords: function (t, e, n) {
							var i = e.length > 1 ? c.pointerAverage(e) : e[0],
								o = {};
							c.getPageXY(i, o), t.page.x = o.x, t.page.y = o.y, c.getClientXY(i, o), t.client.x = o.x, t.client.y = o.y, t.timeStamp = a.number(n) ? n : (new Date).getTime()
						},
						pointerExtend: u,
						getTouchPair: function (t) {
							var e = [];
							return a.array(t) ? (e[0] = t[0], e[1] = t[1]) : "touchend" === t.type ? 1 === t.touches.length ? (e[0] = t.touches[0], e[1] = t.changedTouches[0]) : 0 === t.touches.length && (e[0] = t.changedTouches[0], e[1] = t.changedTouches[1]) : (e[0] = t.touches[0], e[1] = t.touches[1]), e
						},
		...
		49: [
			function (t, e) {
				"use strict";
				for (var n = t("./window"), i = n.window, o = ["ms", "moz", "webkit", "o"], r = 0, s = void 0, a = void 0, u = 0; u < o.length && !i.requestAnimationFrame; u++) s = i[o[u] + "RequestAnimationFrame"], a = i[o[u] + "CancelAnimationFrame"] || i[o[u] + "CancelRequestAnimationFrame"];
				s || (s = function (t) {
				...
				var n = t("./extend"),
					...
					u = {
						...
						resolveRectLike: function (t, e, n, o) {
							return t = u.getStringOptionResult(t, e, n) || t, i["function"](t) && (t = t.apply(null, o)), i.element(t) && (t = a(t)), t
						},
						rectToXY: function (t) {
							return t && {
								x: "x" in t ? t.x : t.left,
						...
						xywhToTlbr: function (t) {
							return !t || "left" in t && "top" in t || (t = n({}, t), t.left = t.x || 0, t.top = t.y || 0, t.right = t.right || t.left + t.width, t.bottom = t.bottom || t.top + t.height), t
						},
						tlbrToXywh: function (t) {
							return !t || "x" in t && "y" in t || (t = n({}, t), t.x = t.left || 0, t.top = t.top || 0, t.width = t.width || t.right - t.x, t.height = t.height || t.bottom - t.y), t
						}
					};
				e.exports = u
			}, {
		...
		51: [
			function (t, e) {
				...
				var i = e.exports,
					o = t("./isWindow");
				"undefined" == typeof window ? (i.window = undefined, i.realWindow = undefined) : n(window), i.getWindow = function (t) {
					if (o(t)) return t;
...
function (t, e) {
	...
	return function (t) {
		...
		function (t, e, n) {
			var i, o, r;
			! function (s, a) {
				o = [t, n(7)], i = a, void 0 !== (r = "function" == typeof i ? i.apply(e, o) : i) && (t.exports = r)
			}(0, function (t, e) {
				"use strict";
		...
		function (t, e, n) {
			var i, o, r;
			! function (s, a) {
				o = [t, n(0), n(2), n(1)], i = a, void 0 !== (r = "function" == typeof i ? i.apply(e, o) : i) && (t.exports = r)
			}(0, function (t, e, n, i) {
				"use strict";
		...
		function (t, e, n) {
			...
			function r(t, e, n, i) {
				return function (n) {
					n.delegateTarget = s(n.target, e), n.delegateTarget && i.call(t, n)
				}
			}
			var s = n(4);
			t.exports = o
...
function (t) {
	...
	function n(t, e) {
		for (var n = {}, i = [], o = 0, r = t.length; o < r; ++o) {
			var s = e ? e(t[o]) : t[o];
			n.hasOwnProperty(s) || (i.push(t[o]), n[s] = 1)
		}
		return i
	}

	function i(t) {
		for (var e = [], n = 0, o = t.length; n < o; n++) e = e.concat(t[n].length ? i(t[n]) : t[n]);
		return e
	}
	...
	function a(t, e, n) {
		return 1 === t.length ? new b(t[0]) : (e = e || 0, n = (n || t.length) - e, t = t.slice(e), n % 2 == 0 ? s(t, n / 2) : b.getAvg(s(t, Math.floor(n / 2)), s(t, Math.ceil(n / 2))))
	}
	...
	function c(t) {
		for (var e, n = [], i = 0; i < t.length; i++) t[i] !== e && (n.push(t[i]), e = t[i]);
		return n
	}
	...
	function l(t) {
		function e(t) {
			for (var e = [], n = 0; n <= 180; n++) {
				...
				if (i[0] === i[i.length - 1]) e.push(n);
				else
					for (var o = c(i), r = o[0], s = 1; s < o.length && x(r, o[s]); s++) s === o.length - 1 && e.push(n)
			}
			return e
		}
		...
		function n(t, e) {
			...
			}), 0 === n.length) throw "Couldn't find gradient angle";
			return n[0].angle
		}
	...
	function d(t, e, n, i) {
		if (t = parseFloat(t), e = parseFloat(e), n = parseFloat(n), i = parseFloat(i), isNaN(t) || isNaN(e) || isNaN(n) || isNaN(i)) throw "Invalid coordinates for Bresenham's";
		t = Math.round(t), e = Math.round(e), n = Math.round(n), i = Math.round(i);
		var o = [],
			r = Math.abs(n - t),
			s = Math.abs(i - e),
			a = t < n ? 1 : -1,
		...
		for (o.push([t, e]); t !== n || e !== i;) {
			var l = 2 * c;
			l > -s && (c -= s, t += a), l < r && (c += r, e += u), o.push([t, e])
		}
		return o
	}
	...
	function h(t, e, n) {
		...
		var i = [];
		return f(t, e, n) ? (i.push(e), n !== t.length - 1 ? i = i.concat(h(t, n, t.length - 1)) : n !== t.length - 1 || 1 === i.length && s(t, 0).equals(s(t, n)) || i.push(n)) : i = i.concat(h(t, e, n - 1)), i
	}
	...
	function y(t, e) {
		...
		n.src = t, n.onload = function () {
			var t = this,
				...
				i = n.getContext("2d");
			n.width = t.width, n.height = t.height, i.drawImage(t, 0, 0), e(m(n))
		}
	}
	...
	function x(t, e) {
		var n = t,
			i = e;
		return t.length && (n = new b(t)), e.length && (i = new b(e)), b.prototype.equals.apply(n, [i])
	}
	var b = function (t) {
		if ("string" == typeof t && (t = t.split(",")), this.r = t[0], this.g = t[1], this.b = t[2], this.a = 4 === t.length ? t[3] : 255, "undefined" == typeof this.r || "undefined" == typeof this.g || "undefined" == typeof this.b) throw "Invalid Color Array passed in"
	};
	b.getAvg = function (t, e) {
		var n = [(t.r + e.r) / 2, (t.g + e.g) / 2, (t.b + e.b) / 2];
		return "undefined" == typeof t.a && (e.a, 0) || (t.a = "undefined" == typeof t.a ? 255 : t.a, e.a = "undefined" == typeof e.a ? 255 : e.a, n.push((t.a + e.a) / 2)), new b(n)
	}, b.prototype.equals = function (t, e) {
		if (e = void 0 === e ? 70 : e, Math.abs(this.r - t.r) > e) return !1;
		...
		t.width = this.colorarray[0].length, t.height = this.colorarray.length;
		var e = t.getContext("2d"),
			n = e.createImageData(t.width, t.height);
		return o(i(this.colorarray), n.data), e.clearRect(0, 0, t.width, t.height), e.putImageData(n, 0, 0), t
	}, r.prototype.toCss = function () {
		if (1 === this.stops.length) return "background-color: " + this.stops[0].color.toString();
...
}(window), GradientCanvas.fromExportable = function (t) {
	...
	return n[e] && (e = n[e]), isNaN(parseInt(e)) || (e = i + "deg"), e
	...
	var n = this.getAngle(),
		...
		r = t(e(180 - o)),
		s = t(e(360 - o));
	return 0 >= r.x || i >= Math.abs(r.x) ? r.x = 0 : (o > 90 && 180 > o || o > 270 && 360 > o) && (r.x = parseFloat(r.x + .3)), 0 >= r.y || i >= Math.abs(r.y) ? r.y = 0 : (o > 90 && 180 > o || o > 270 && 360 > o) && (r.y = parseFloat(r.y + .3)), 0 >= s.x || i >= Math.abs(s.x) ? s.x = 0 : (o > 90 && 180 > o || o > 270 && 360 > o) && (s.x = parseFloat(s.x + .3)), 0 >= s.y || i >= Math.abs(s.y) ? s.y = 0 : (o > 90 && 180 > o || o > 270 && 360 > o) && (s.y = parseFloat(s.y + .3)), {
		x1: parseInt(100 * r.x),
		y1: parseInt(100 * r.y),
		x2: parseInt(100 * s.x),
		y2: parseInt(100 * s.y)
	...
	var e = this._colorStops.indexOf(t); - 1 != e && this._colorStops.splice(e, 1)
}, GradientCanvas.prototype.removeAlphaStop = function (t) {
	var e = this._alphaStops.indexOf(t); - 1 != e && this._alphaStops.splice(e, 1)
	...
	return 2 > n.length && (n = []), e.concat(n).unique(function (t) {
		return t.offset
	}).sort(function (t, e) {
	...
	i || (s = this.angleToGradientVector(this.angle)), s.x1 = s.x1 / 100 * t, s.x2 = s.x2 / 100 * t, s.y1 = s.y1 / 100 * e, s.y2 = s.y2 / 100 * e;
	for (var a = r.createLinearGradient(s.x1, s.y1, s.x2, s.y2), u = n || this.getAllStops(), c = 0; u.length > c; c++) a.addColorStop(Math.max(0, Math.min(1, u[c].offset)), u[c].color);
	return r.fillStyle = a, r.fillRect(0, 0, t, e), o
}, GradientCanvas.prototype.toCanvasRules = function (t, e) {
	var n = this.angleToGradientVector(this.angle);
	n.x1 = n.x1 / 100 * t, n.x2 = n.x2 / 100 * t, n.y1 = n.y1 / 100 * e, n.y2 = n.y2 / 100 * e;
	...
	if (e) {
		...
		Math.abs(n - a) < Math.abs(n - u) && (a = u), Math.abs(n - a) < Math.abs(n - c) && (a = c), n = (n + a) / 2
	}
	...
	return this._colorStops.push(i), this.getColorStops().indexOf(i)
	...
	function n(n, r, a) {
		function u(t, e, i) {
			...
			return t.each(function (t, u) {
				...
				var l = c[e];
				if (!l || "_" == e.charAt(0)) return void s(r + " is not a valid method");
				var p = l.apply(c, i);
				o = void 0 === o ? p : o
			}), void 0 !== o ? o : t
		}
...
function (t, e) {
	...
	function o() {
		if (!l) {
			...
			n.appendChild(e);
			var o = i(e);
			s = 200 == Math.round(t(o.width)), r.isBoxSizeOuter = s, n.removeChild(e)
		}
	}
	...
	function r(e) {
		if (o(), "string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
			...
			var E = t(r.height);
			return !1 !== E && (a.height = E + (w ? 0 : v + b)), a.innerWidth = a.width - (g + x), a.innerHeight = a.height - (v + b), a.outerWidth = a.width + m, a.outerHeight = a.height + y, a
		}
	}
...
function (t, e) {
	...
	l.constructor = i, l._create = function () {
		...
		e[c] = this.getYValue(p), e[l] = "", this.css(e), this.emitEvent("layout", [this])
...
function (t, e) {
	...
	i.extend(f, e.prototype), f.option = function (t) {
		...
		var n = s(r);
		return n.defaults = i.extend({}, r.defaults), i.extend(n.defaults, e), n.compatOptions = i.extend({}, r.compatOptions), n.namespace = t, n.data = r.data, n.Item = s(o), i.htmlInit(n, t), c && c.bridget && c.bridget(t, n), n
	};
	var h = {
		ms: 1,
		s: 1e3
...
function (t, e) {
	...
	return i._resetLayout = function () {
		...
		for (var o = this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition", r = this[o](i, t), s = {
			...
			y: r.y
		}, a = r.y + t.size.outerHeight, u = i + r.col, c = r.col; c < u; c++) this.colYs[c] = a;
		return s
		...
		for (var c = this._getOption("originTop"), l = (c ? i.top : i.bottom) + n.outerHeight, p = a; p <= u; p++) this.colYs[p] = Math.max(l, this.colYs[p])
...
function (t, e) {
	...
	}, p._init = p.arrange, p._hideReveal = function (t) {
...
}), window.$ = document.querySelectorAll.bind(document), Node.prototype.on = window.on = function (t, e) {
	this.addEventListener(t, e)
}, NodeList.prototype.__proto__ = Array.prototype, NodeList.prototype.on = NodeList.prototype.addEventListener = function (t, e) {
...
var isMobile = window.matchMedia("(max-width: 640px)").matches,
	ColorPicker = function (t) {
		...
		return e.setAlphaColor = function (t) {
			...
			var n = t.color[0],
				...
				r = t.color[3],
				s = "rgba(" + n + "," + i + "," + o + "," + r + ")";
			e.joe.set(s), e.setAlphaColor(t)
		}, n(), e
	},
	AnglePicker = function (t, e) {
		var n = Object.create(AnglePicker.prototype);
		n.gradient = t, n.angle = e, n.angleContainer = $(".js-angle")[0], n.pointer = $(".js-pointer")[0], n.input = $(".js-angle-input")[0], n.dragging = !1, n.x = 0, n.y = 0;
		var i = function () {
				n.pointer.style.transform = "translateZ(0px) rotate(" + n.angle + "deg)", n.input.value = n.angle + "\xb0", o()
			},
			o = function () {
				n.input.on("change", s)
			};
		"ontouchstart" in document.documentElement ? (n.angleContainer.on("touchstart", function (t) {
			t.preventDefault(), t.stopPropagation(), n.x = t.offsetX || t.layerX, n.y = t.offsetY || t.layerY, a()
		}), n.angleContainer.on("touchmove", function (t) {
			t.preventDefault(), t.stopPropagation(), n.dragging = !0, n.x = t.offsetX || t.layerX, n.y = t.offsetY || t.layerY
			...
			n.dragging = !0, n.x = t.offsetX, n.y = t.offsetY, a()
		...
		var r = function () {
				n.pointer.style.transform = "translateZ(0px) rotate(" + n.angle + "deg)", n.input.value = n.angle + "\xb0", n.gradient.updateAngle(n.angle)
			},
			s = function (t) {
				n.angle = Math.round(parseInt(t.target.value)), r()
			},
			a = function () {
				x2 = n.x, y2 = n.y, radians = Math.atan2(y2 - 15, x2 - 15), e = radians * (180 / Math.PI), e = 90 + e, e < 0 && (e = 360 + e), e = Math.round(e), n.pointer.style.transform = "translateZ(0px) rotate(" + e + "deg)", n.input.value = Math.round(e) + "\xb0", n.gradient.updateAngle(e)
			};
		n.setAngle = function (t) {
			n.input.value = Math.round(t) + "\xb0", r()
		};
	...
	Drag = function (t, e, n) {
		...
		i.point = t, i.dom = e, i.width = n;
		var o = function () {},
			r = function (t) {
				var e = t.target,
					n = (parseFloat(e.getAttribute("data-x")) || 0) + t.dx;
				if ("undefined" != typeof t.restrict && Math.abs(t.restrict.dy) > 120) return void i.point.destroy();
				e.style.webkitTransform = e.style.transform = "translateX(" + n + "px)", e.setAttribute("data-x", n);
				var o = Math.round(n / (i.width - 28) * 100);
				o > 100 && (o = 100), i.point.setPosition(o)
			},
			s = function () {
				i.point.updateStop()
			};
	...
	Point = function (t, e, n) {
		...
		i.gradient = t, i.color = e ? e[0] : [0, 0, 0, 0], i.position = e ? e[1] : 0, i.isActive = !1, i.input, i.pointBG, i.stop, i.tile, i.inputHex, i.inputPosition, i.deleteButton;
		var o = function () {
				i.dom = document.createElement("div"), i.dom.classList.add("js-draggable"), i.dom.classList.add("app-gradient__point"), p(), c(), f(), h()
			},
			r = function () {
				var t = s();
			...
			u = function () {
				i.position = this.value, i.setPosition(i.position);
				var t = Math.round(.01 * i.position * (i.gradient.width - 28));
				i.dom.dataset.x = t, i.dom.style.transform = "translateX(" + t + "px)"
			},
			c = function () {
				i.inputHex.value = r();
				var t = s();
				i.pointBG.style.backgroundColor = t, i.tile.style.backgroundColor = t
			},
			l = function () {
				var t = document.createElement("label");
				t.classList.add("app-gradient__point-label");
				var e = document.createElement("div");
				return e.classList.add("app-gradient__point-label-bg"), i.input = document.createElement("input"), i.input.classList.add("app-gradient__point-input"), i.input.value = i.position, t.appendChild(e), t.appendChild(i.input), t
			},
			p = function () {
				var t = Math.round(.01 * i.position * (i.gradient.width - 28));
				i.dom.dataset.x = t, i.dom.style.transform = "translateX(" + t + "px)", i.dom.setAttribute("touch-action", "none");
				var e = document.createElement("div");
				e.classList.add("app-gradient__point-background");
				var n = document.createElement("div");
				n.classList.add("app-gradient__point-visual"), i.pointBG = document.createElement("div"), i.pointBG.classList.add("app-gradient__point-color"), i.dom.appendChild(e), i.dom.appendChild(n), i.dom.appendChild(i.pointBG), i.dom.appendChild(l()), i.gradient.container.appendChild(i.dom), d()
			},
			d = function () {
				var t = $(".js-stops")[0];
				i.stop = document.createElement("div"), i.stop.classList.add("app-color__stop"), i.isActive && i.stop.classList.add("is-active");
				var e = document.createElement("div");
				e.classList.add("app-color__stop-color");
				var o = document.createElement("div");
				o.classList.add("app-color__stop-color-bg"), i.tile = document.createElement("div"), i.tile.classList.add("app-color__stop-color-tile"), i.tile.style.backgroundColor = s(), o.appendChild(i.tile), e.appendChild(o);
				var a = document.createElement("div");
				a.classList.add("app-color__stop-hex"), i.inputHex = document.createElement("input"), i.inputHex.value = r(), a.appendChild(i.inputHex);
				var u = document.createElement("div");
				u.classList.add("app-color__stop-position"), i.inputPosition = document.createElement("input"), i.inputPosition.value = i.position, u.appendChild(i.inputPosition);
				var c = document.createElement("div");
				c.classList.add("app-color__stop-action"), i.deleteButton = document.createElement("button"), i.deleteButton.classList.add("app-color__stop-action-button"), i.deleteButton.innerHTML = "&times", c.appendChild(i.deleteButton), i.stop.appendChild(e), i.stop.appendChild(a), i.stop.appendChild(u), i.stop.appendChild(c), n ? (t.insertBefore(i.stop, n.stop), n = null) : t.appendChild(i.stop), h()
			},
			f = function () {
				Drag(i, i.dom, i.gradient.width);
				i.dom.on("pointerdown", a), i.input.on("change", u)
			},
			h = function () {
				i.tile.on("click", i.setActive), i.inputHex.on("change", i.setHex), i.inputHex.on("focus", i.setActive), i.inputPosition.on("change", u), i.inputPosition.on("focus", i.setActive), i.deleteButton.on("click", i.destroy)
			};
		return i.renderStop = d, i.updateStop = i.gradient.renderStops, i.setActive = function () {
			i.isActive = !0, i.dom.classList.add("is-active"), i.stop.classList.add("is-active"), i.gradient.setCurrentPoint(i)
		}, i.removeActive = function () {
			i.isActive = !1, i.dom.classList.remove("is-active"), i.stop.classList.remove("is-active")
		}, i.setHex = function (t) {
			...
			i.setColor(s), i.gradient.updatePicker()
		}, i.setColor = function (t) {
			i.color = t, c()
		}, i.setPosition = function (t) {
			i.position = t, i.input.value = t, i.inputPosition.value = t, i.gradient.updateGradient(i), i.updateStop()
		}, i.checkDelete = function () {
			"INPUT" !== document.activeElement.tagName && i.isActive && i.destroy()
		}, i.destroy = function () {
			if (i.gradient.points.length <= 2) return void console.warn("You must have at least 2 points");
			i.dom.parentNode.removeChild(i.dom), i.stop.parentNode.removeChild(i.stop), i.gradient.removePoint(i)
		}, i.clear = function () {
			i.dom.parentNode.removeChild(i.dom), i.stop.parentNode.removeChild(i.stop)
		}, o(), i
	},
	Gradient = function (t, e, n, i) {
		var o = Object.create(Gradient.prototype);
		o.stops = t, o.type = e, o.angle = n, o.index = i, o.points = [], o.currentPoint, o.colorPicker, o.gradientBackground = $(".js-header")[0], o.gradientToolBackground = $(".js-background")[0], o.gradientCopyButton = $(".js-button-copy")[0], o.stopsDOM = $(".js-stops")[0], o.container = $(".js-drag")[0], o.width = o.container.scrollWidth, o.code = $(".js-code")[0], o.buttonLinear = $(".js-button-linear")[0], o.buttonRadial = $(".js-button-radial")[0], o.swatch = $(".js-swatch")[i];
		var r = function () {
				o.colorPicker = ColorPicker(o), o.anglePicker = AnglePicker(o, o.angle), t.forEach(function (t) {
					var e = Point(o, t);
					o.points.push(e)
				}), o.points[1].setActive(!0), "linear-gradient" === o.type ? u(null, !0) : c(null, !0), m()
			},
			s = function (t) {
			...
			a = function (t) {
				if (t.target.classList.contains("js-drag")) {
					...
					if (o.points.some(function (t) {
						if (t.position <= r) e = t;
						else if (t.position >= r) return n = t, !0
					}), e && n) {
					...
					var u = Point(o, i, n);
					o.points.push(u), u.setActive(), o.setCurrentPoint(u), p()
				}
			},
			u = function (t, e) {
				o.buttonRadial.classList.remove("is-active"), o.buttonLinear.classList.add("is-active"), o.type = "linear-gradient", $(".app-option")[1].style.display = "block", e || p()
			},
			c = function (t, e) {
				o.buttonLinear.classList.remove("is-active"), o.buttonRadial.classList.add("is-active"), o.type = "radial-gradient", $(".app-option")[1].style.display = "none", e || p()
			},
			l = function () {
			...
			p = function () {
				...
				var t;
				t = "linear-gradient" === o.type ? o.type + "(" + o.angle + "deg, " : o.type + "(circle, ", t += d(), o.gradientBackground.style.backgroundImage = t, o.gradientToolBackground.style.backgroundImage = l(), o.swatch.childNodes[1].style.backgroundImage = t, o.gradientCopyButton.style.backgroundImage = t, f(), v()
			},
			d = function () {
				var t = "";
				return o.points.forEach(function (e, n) {
					...
					n < o.points.length - 1 && (u += ", "), t += u
				}), t += ")"
			},
			f = function () {
				if (0 !== o.points.length) {
					var t = (o.points[0].color[0], o.points[0].color[1], o.points[0].color[2], window.isCompat ? g : h);
					o.code.innerHTML = t()
				}
			},
			h = function () {
				...
				return r += '<span class="blue">background</span>: ', r += t + d() + ";"
			},
			g = function () {
				var t = "",
					e = o.points[0].color[0],
				...
				return h += '<span class="blue">background</span>: ', h += "-moz-" + t + d() + ";<br>", h += '<span class="blue">background</span>: ', h += "-webkit-" + t + d() + ";<br>", h += '<span class="blue">background</span>: ', h += t + d() + ";<br>", h += '<span class="blue">filter</span>: progid:DXImageTransform.Microsoft.gradient(startColorstr="' + s + '",endColorstr="' + f + '",GradientType=1);'
			},
			v = function () {
				var t = [],
					e = [];
				o.points.forEach(function (t) {
					...
					e.push(n)
				}), t.push(e), t.push(o.type), t.push(o.angle), STOPS[o.index] = t, localStorage.setItem("STOPS", JSON.stringify(STOPS))
			},
			m = function () {
				o.container.on("click", a), document.on("keyup", s), o.buttonLinear.on("click", u), o.buttonRadial.on("click", c)
			};
		return o.renderStops = function () {
			o.stopsDOM.innerHTML = "", o.points.forEach(function (t) {
				t.renderStop()
			})
			...
			o.points.map(function (t, n) {
				n != e && t.removeActive()
			}), o.currentPoint = t, o.colorPicker.setColor(t)
		}, o.updatePicker = function () {
			o.colorPicker.setColor(o.currentPoint)
		}, o.updateColor = function (t) {
			o.currentPoint.setColor(t), o.colorPicker.setAlphaColor(o.currentPoint), p()
			...
			o.stops = t, o.type = e, o.angle = n, o.index = i, o.swatch = $(".js-swatch")[i], o.anglePicker = AnglePicker(o, o.angle), o.points.forEach(function (t) {
				t.clear()
			}), o.points = [], o.stops.forEach(function (t) {
				var e = Point(o, t);
				o.points.push(e)
			}), o.points[1].setActive(!0), "linear-gradient" === o.type ? u(null, !0) : c(null, !0)
		}, o.rerenderCode = f, r(), o
	},
	App = function () {
		var t = Object.create(App.prototype);
		t.swatches = $(".js-swatch"), t.upload = $(".js-upload")[0], t.compat = $(".js-compat")[0], t.gradient = null, window.isCompat = JSON.parse(localStorage.getItem("isCompat")) || !1;
		var e = function () {
				n(), t.swatches.forEach(function (t, e) {
					t.childNodes[1].style.backgroundImage = i(STOPS[e]), e === CURRENT_STOP && t.classList.add("is-active")
				});
				var e = STOPS[CURRENT_STOP][0],
					o = STOPS[CURRENT_STOP][1],
					r = STOPS[CURRENT_STOP][2];
				t.gradient = Gradient(e, o, r, CURRENT_STOP), window.isCompat ? (t.compat.checked = !0, $(".code-editor__column-numbers")[0].innerHTML = "1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>") : $(".code-editor__column-numbers")[0].innerHTML = "1<br>2<br>3<br>4<br>5<br>6<br>", u()
			},
			n = function () {
				new ClipboardJS(".js-copy").on("success", function (t) {
					var e = $(".js-button-copy")[0];
					e.style.transition = "all 250ms ease-in-out", e.style.transform = "translateY(0) scaleX(0.02) scaleY(0.5)", setTimeout(function () {
						e.style.opacity = 0
					}, 200), setTimeout(function () {
						e.style.transition = "all 1ms linear", e.style.transform = ""
					}, 500), setTimeout(function () {
						e.style.opacity = 1, e.style.transition = "all 150ms ease-in-out"
					}, 600), t.clearSelection()
				})
			},
			i = function (t) {
				var e, n = t[0];
				return e = "linear-gradient" === t[1] ? "linear-gradient(" + t[2] + "deg, " : "radial-gradient(circle, ", n.forEach(function (t, i) {
					var o = t[0][0],
						r = t[0][1],
						s = t[0][2],
						a = t[0][3],
			...
			o = function () {
				...
				var e = t.swatches.indexOf(this),
					...
					i = STOPS[e][1],
					o = STOPS[e][2];
				t.gradient.rerender(n, i, o, e), CURRENT_STOP = e, localStorage.setItem("CURRENT_STOP", JSON.stringify(CURRENT_STOP))
			},
			r = function (e) {
				var n = [
					[], "linear-gradient", 0
				...
				GradientFinder.fromUrl(e, function (e) {
					n[2] = e.angle, e.stops.forEach(function (t) {
						var e = t.color,
							i = [e.r, e.g, e.b, 1],
							o = [i, 100 * t.idx];
						n[0].push(o)
			...
			a = function (e) {
				window.isCompat = e.target.checked, window.isCompat ? $(".code-editor__column-numbers")[0].innerHTML = "1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>" : $(".code-editor__column-numbers")[0].innerHTML = "1<br>2<br>3<br>4<br>5<br>6<br>", localStorage.setItem("isCompat", JSON.stringify(window.isCompat)), t.gradient.rerenderCode()
			},
			u = function () {
				t.swatches.on("click", o), t.upload.on("change", s), t.compat.on("change", a)
			};
		return window.STOPS = [
			[
				[
		...
		], STOPS = JSON.parse(localStorage.getItem("STOPS")) || STOPS, localStorage.setItem("STOPS", JSON.stringify(STOPS)), window.CURRENT_STOP = JSON.parse(localStorage.getItem("CURRENT_STOP")) || 0, e(), t
	},
	Backgrounds = function () {
		var t = Object.create(Backgrounds.prototype),
			e = function () {
				t.links = $(".js-backgrounds-link"), t.shades = $(".js-backgrounds-shade"), t.iframe = $(".js-iframe")[0], o(t.links[1]), r(), s()
			},
			n = function (e) {
				e.preventDefault(), t.links.forEach(function (t) {
					t.classList.remove("is-active")
				}), this.querySelector(".sidenav-backgrounds__background").style.transform = "", this.classList.add("is-active"), isMobile ? window.open(this.href) : (o(this), i(this.href))
			},
			i = function (e) {
				t.shades.forEach(function (t) {
					setTimeout(function () {
						t.style.visibility = "visible", t.style.transform = "scaleX(1) scaleY(1)"
					}, 300 * Math.random())
				}), setTimeout(function () {
					...
					t.shades.forEach(function (t) {
						t.style.transition = "all 0ms linear", t.style.transform = "scaleX(1) scaleY(0)"
					})
			...
			r = function () {
				setTimeout(function () {
					$("#ad_iframe")[0] ? (console.log("ad loaded"), $("#ad_iframe")[0].getAttribute("height")) : console.log("ad failed to load")
				}, 1500)
			},
			s = function () {
				t.links.on("click", n)
...
if (document.body.classList.contains("color-shades")) {
	var count = $(".js-filter-count")[0],
		...
		init = function () {
			iso = new Isotope(shades, {
				...
				layoutMode: "fitRows"
			}), setFilters(), setClipboard()
		},
		setActiveFilter = function () {
			var t = this.dataset.filter;
			filters.forEach(function (t) {
				t.classList.remove("is-active")
			}), this.classList.add("is-active"), iso.arrange({
				filter: t
			}), updateFilterCount()
		},
		setFilters = function () {
		...
		setClipboard = function () {
			new ClipboardJS(".js-copy").on("success", function (t) {
				...
				n.classList.add("is-copied"), setTimeout(function () {
...
if (document.body.classList.contains("gradient-backgrounds")) var backgrounds = Backgrounds();
! function () {
