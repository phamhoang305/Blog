    ...
    */
    ...
    {   $user = \App\User::find(user()->id);
        ...
        return [
            ...
            // 'phone'=>'max:15|unique:users,phone,'.$user->id,
            'about'=>'max:300',
        ];
    ...
    {
        return [
            'username.required'=>"Không được trống !",
            'username.unique'=>"ID đã được sử dụng !",
            'username.max'=>"Không quá :max ký tự !",
            ...
            // 'phone.unique'=>"Số điện thoại đã được sủ dụng !",
